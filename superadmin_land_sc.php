    ...
    <div class="pmo-page-header anim-in">
      ...
      <div style="display:flex;flex-direction:column;align-items:flex-end;gap:10px;position:relative;">
        ...
        <div class="header-btns">
          <a href="superadmin_land_inventory.php" class="pmo-btn" style="background:rgba(255,255,255,.15);border-color:rgba(255,255,255,.25);color:var(--white);backdrop-filter:blur(4px);">
            <i class="fas fa-clipboard-list"></i> Inventory <span style="font-size:10px;opacity:.7;">(Coming Soon)</span>
          </a>
...
if (mysqli_num_rows($result) > 0) {
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    $desc .= !empty($row['specific_description']) ? "<strong>Description:</strong> "      . htmlspecialchars($row['specific_description']) . "<br>" : "";
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="pmo-modal-body modal-body">
          <form id="addAssetForm" method="post" action="superadmin_add_asset_process_sc.php">
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="pmo-modal-body modal-body" id="editModalBody" style="position:relative;">
          ...
          <form id="editAssetForm" method="post" action="superadmin_edit_asset_process_land_sc.php">
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content" style="text-align:center;">
        <div class="modal-body" style="padding:36px 28px;">
          ...
          <button class="pmo-btn" style="border-color:var(--red);color:var(--red);width:100%;justify-content:center;" data-bs-dismiss="modal" class="mt-3">Close</button>
        </div>
      </div>
    </div>
  </div>
